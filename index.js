...
app.use(function (req,res,next){
 res.setHeader('Access-Control-Allow-Origin','https://elevenstar.sofabespoke.co.uk,http://localhost:3000')
...
app.use(cors({
origin:['https://elevenstar.sofabespoke.co.uk','http://localhost:3000'],
